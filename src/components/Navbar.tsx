...
export const NAV_TABS: Array<{ id: TabType; label: string }> = [
  ...
  { id: 'recurring', label: 'Recurring Automation' },
    ...
    <header className="sticky top-0 z-40 w-full border-b border-slate-200 bg-white/95 backdrop-blur dark:border-slate-800 dark:bg-slate-900/95 transition-colors">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="flex h-16 items-center justify-between gap-4">
          ...
          >
            <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-emerald-600 text-white shadow-sm shadow-emerald-500/20 font-bold text-lg">
              Rs
            </div>
            <div>
          ...
          {/* Controls: Month Selector, Stress pill, Backup, Theme */}
          <div className="flex items-center gap-2 sm:gap-3">
            {/* Month Filter */}
            <div className="flex items-center rounded-lg border border-slate-200 bg-slate-50 px-2.5 py-1.5 text-xs font-medium dark:border-slate-700 dark:bg-slate-800 text-slate-700 dark:text-slate-200">
            ...
            <button
              ...
              className="inline-flex items-center gap-1.5 rounded-lg bg-rose-600 px-3 py-1.5 text-xs font-semibold text-white shadow-sm hover:bg-rose-700 transition"
            >
              <PlusCircle className="h-3.5 w-3.5" />
              <span className="hidden sm:inline">Add Expense</span>
            </button>

            {/* Stress level indicator pill */}
            <button
              onClick={() => onSelectTab('stress')}
              className="hidden md:flex items-center gap-1.5 rounded-lg px-2.5 py-1.5 text-xs font-semibold transition bg-emerald-50 text-emerald-800 hover:bg-emerald-100 dark:bg-emerald-950/60 dark:text-emerald-300 border border-emerald-200 dark:border-emerald-800"
        ...
        <nav className="flex space-x-1 overflow-x-auto pb-2 scrollbar-none text-xs font-medium border-t border-slate-100 dark:border-slate-800/80 pt-2">
          {NAV_TABS.map((tab) => {
